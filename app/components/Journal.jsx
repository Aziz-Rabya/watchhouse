...
const Journal = () => {
  return (
    <div className="bg-[#f6f1e9] px-6 py-20 mt-20">
      {/* Top Title Section */}
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10 mx-20">
        ...
        <div className="lg:w-2/3 max-w-[700px]">
          ...
          <button className="group relative overflow-hidden rounded-full px-6 py-2 mt-6 bg-transparent text-black border border-black font-thin uppercase">
            <span
      ...
      <section className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 mx-20">
        {/* NOMAD Feature */}
        <div className="relative rounded-lg overflow-hidden h-[700px] flex items-center justify-center text-center">
          <img
