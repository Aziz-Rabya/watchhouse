...
const Subscribe = () => {
  ...
  return (
    <section className="font-serif bg-white px-12 py-12 md:flex flex-col lg:flex-row gap-10 mt-50">
      {/* LEFT SECTION */}
      ...
      <div className="flex-1 overflow-x-auto">
        <div className="flex gap-6 pb-4">
          {products.map((item, index) => (
            <div
              key={index}
              className={`flex-shrink-0 rounded-xl p-6 w-80 shadow bg-gradient-to-b ${
            ...
            >
              <div className="flex flex-col">
                ...
                <button className="w-full py-2 bg-white text-black rounded-full shadow-sm text-sm font-semibold hover:bg-gray-100 transition">
